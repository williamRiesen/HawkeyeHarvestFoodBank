                    ...
                    .addOnSuccessListener { querySnapshot ->
                        when (querySnapshot.size()) {
                            ...
                            1 -> {
                                ...
                                editTextAccountID.setText(account.accountID)
                                editTextAccountID.visibility = View.VISIBLE
                                editTextFamilySize.setText(account.familySize.toString())
                                editTextCity.setText(account.city)
                                editTextCounty.setText(account.county)
