...
//        return true
    ...
    fun sendObjectCatalogToFireStore() {
        ...
        myObjectCatalog.foodItemList = listOf(
            ...
            FoodItem(113,"Chicken Fajita 5lb (4 pts, limit 1)","Meat",4,1,100,true,1),
            ...
            FoodItem(145, "Cooked Seasoned Pork Shredded 3lb (2pts, Limit 2)","Meat",2,2,100,true,1),
            ...
            FoodItem(39, "Baked", "Beans", 1, 100, 100, true, 5),
            ...
            FoodItem(51, "Ramen Noodle", "Soups", 1, 100, 100, true, 6),
            ...
            FoodItem(106,"Tomato Veg Juice 5 cans (Limit 2)","Processed Tomato",1,2,100,false,7),
...
//            FoodItem(68, "Spaghetti", "Pasta", 1, 100, 100, true, 10),
            ...
            FoodItem(115, "Sugar Cookie Decorating Kit", "Extra",1,100,100,false,12 ),
            ...
            FoodItem(125,"Sugar Free Chocolate Swirl Pudding (Limit 2)","Pudding",1,2,100,true,16),
            ...
            FoodItem(147,"Shredded Cheddar Cheese 32 oz","Dairy (except milk)",1,100,100,true,17),
            FoodItem(148, "Pumpkin Rolls", "Dairy (except milk)",1,100,100,true, 17),
