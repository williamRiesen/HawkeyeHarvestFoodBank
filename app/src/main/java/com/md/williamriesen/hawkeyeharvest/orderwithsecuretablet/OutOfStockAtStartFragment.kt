...
class OutOfStockAtStartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        buttonOK2.setOnClickListener {
            Navigation.findNavController(it).navigate(R.id.action_outOfStockFragment3_to_secureTabletOrderSelectionFragment)
