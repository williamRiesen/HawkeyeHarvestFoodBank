...
//        return hour24 < 17
    ...
    fun sendObjectCatalogToFireStore() {
        ...
        myObjectCatalog.foodItemList = listOf(
            ...
            FoodItem(10, "Ground Beef 1lb (Limit 2)", "Meat", 1, 2, 100, false, 1),
            ...
            FoodItem(13, "Whole Chicken 3lb (Limit 2)", "Meat", 1, 2, 100, true, 1),
            FoodItem(14, "Chicken Legs 5lb", "Meat", 1, 100, 100, false, 1),
            FoodItem(3, "Large Whole Ham 10lb (3pts, Limit 1)", "Meat", 3, 1, 100, true, 1),
            FoodItem(4, "Catfish Fillets 2lb (2pts, Limit 2)", "Meat", 2, 2, 100, true, 1),
            FoodItem(5, "Pork Loin 4lb (2pts)", "Meat", 2, 100, 100, false, 1),
            FoodItem(6, "Chicken Thighs 5lb (2pts, Limit 2)", "Meat", 2, 2, 100, false, 1),
            FoodItem(7, "Pork Shoulder Roast 6lb (2pts)", "Meat", 2, 100, 100, false, 1),
            FoodItem(2, "Cooked Chicken Fajita 5lb (4pts)", "Meat", 4, 100, 100, false, 1),
            FoodItem(1, "Cooked Chicken Fillets 5lb (4pts)", "Meat", 4, 100, 100, false, 1),
            FoodItem(89, "Cooked Chicken Patties 5lb (4pts, Limit 1)", "Meat", 4, 1, 100, true, 1),
                FoodItem(
                90,
                ...
                true,
                1),
            FoodItem(109, "Chicken Leg Quarters 10# (Limit 1","Meat",4,1,100,true,1),
            FoodItem(110, "Sliced Turkey Bologna 2lb (Limit 2)","Meat",1,2,100,true,1),
            FoodItem(111, "Ground Pork 1lb (Limit 2)", "Meat", 1,2,100,true,1),
            FoodItem(112, "Italian Hot Ham 5lb (Limit 2)", "Meat",1,2,100,true,1),
            FoodItem(113,"Chicken Fajita (4 pts, limit 1)","Meat",4,1,100,true,1),
            FoodItem(91, "McDonald's Chicken Tenders 3lb (Limit 2)", "Meat", 1, 2, 100, true, 1),
            FoodItem(93, "Small Ham 3lb (Limit 2)", "Meat", 1, 2, 100, true, 1),
            ...
            FoodItem(27, "Cranberry Juice", "Fruits", 1, 100, 100, true, 4),
            ...
            FoodItem(32, "Applesauce", "Fruits", 1, 100, 100, true, 4),
            ...
            FoodItem(39, "Kidney", "Beans", 1, 100, 100, false, 5),
            ...
            FoodItem(98, "Chickpeas", "Beans", 1, 100, 100, true, 5),
            ...
            FoodItem(51, "Chicken/Dumpling", "Soups", 1, 100, 100, false, 6),
            ...
            FoodItem(106,"Tomato Veg Juice 5 cans (Limit 2)","Processed Tomato",1,2,100,true,7),
            ...
            FoodItem(66, "Rotini/Cellentani", "Pasta", 1, 100, 100, false, 10),
...
//            FoodItem(68, "Spaghetti", "Pasta", 1, 100, 100, true, 10),
            ...
            FoodItem(103, "Dried Fruit & Nuts (Limit 2)", "Extra", 1, 2, 100, true, 12),
            FoodItem(104, "Ranch Dressing (Limit 1)", "Extra", 1, 1, 100, true, 12),
            FoodItem(108,"White Flour (Limit 1)","Extra",1,1,100,true,12),
            FoodItem(114, "Fruit by the Foot (Limit 1)", "Extra",1,1,100,true,12),
            FoodItem(115, "Fruit Snacks (Limit 1)", "Extra",1,1,100,true,12),
            FoodItem(115, "Sugar Cookie Decorating Kit", "Extra",1,100,100,true,12 ),
            FoodItem(116,"Selzer Water (6 pack)","Extra",1,100,100,true,12),

            FoodItem(117,"Little Bites","Extra",1,100,100,true,12),
            FoodItem(118,"Donuts","Extra",1,100,100,true,12),
            FoodItem(119,"Pound Cakes","Extra",1,100,100,true,12),
            FoodItem(120,"Pick Me Up","Extra",1,100,100,true,12),
            FoodItem(121,"Marshmallow Cookies","Extra",1,100,100,true,12),
            FoodItem(122,"Chocolate Cupcakes","Extra",1,100,100,true,12),
            ...
            FoodItem(88, "Laundry Soap (Homemade- Limit 1)", "Nonedibles", 1, 1, 100, false, 13),
